...
import { AlertDialog } from '../components/DialogOverlays'
  ...
  return (
    <section className="space-y-6">
      ...
      <AlertDialog
        ...
        message="A document with this number is already in the system. The upload was not saved — the existing record is unchanged."
        buttonLabel="Got it"
